    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            @foreach ($antreanHariIni as $queue)
                @if ($queue->user_id == $userId && $queue->status == 'periksa')
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <strong>Halo!</strong> Antrian anda sudah dipanggil. Silakan menuju ruang periksa.
                            ...
                            <tbody>
                                @foreach ($antreanHariIni as $queue)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($queue->tgl_periksa)->locale('id')->translatedFormat('l') }},
                                            {{ $queue->tgl_periksa }}</td>
                                        <td>
